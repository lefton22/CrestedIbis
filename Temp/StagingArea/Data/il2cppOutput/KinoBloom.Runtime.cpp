...
IL_002a:
	{
		...
		int32_t L_8 = V_1;
		float L_9;
		L_9 = Mathf_Log_mF7F3624FA030AB57AD8C1F4CAF084B2DCC99897A(((float)((float)L_8)), (2.0f), /*hidden argument*/NULL);
		...
		int32_t L_12 = V_4;
		int32_t L_13;
		L_13 = Mathf_Clamp_mAD0781EB7470594CD4482DD64A0D739E4E539C3C(L_12, 1, ((int32_t)16), /*hidden argument*/NULL);
		V_5 = L_13;
		...
		L_25 = Vector4_op_Implicit_mDCFA56E9D34979E1E2BFE6C2D61F1768D934A8EB(L_24, /*hidden argument*/NULL);
...
IL_00e1:
	{
		...
		L_38 = RenderTexture_GetTemporary_mEA38E780ED9C1E065B97E85BBC63F8DE548C7B8E(L_35, L_36, 0, L_37, /*hidden argument*/NULL);
		V_10 = L_38;
...
IL_012e:
	{
		...
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_40, L_41, L_42, L_43, /*hidden argument*/NULL);
...
IL_0149:
	{
		...
		L_52 = RenderTexture_GetTemporary_mEA38E780ED9C1E065B97E85BBC63F8DE548C7B8E(((int32_t)((int32_t)L_48/(int32_t)2)), ((int32_t)((int32_t)L_50/(int32_t)2)), 0, L_51, /*hidden argument*/NULL);
		ArrayElementTypeCheck (L_45, L_52);
		(L_45)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_46), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)L_52);
...
IL_017e:
	{
		...
		int32_t L_57 = V_13;
		int32_t L_58 = L_57;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_59 = (L_56)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_58));
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_60 = __this->get__material_11();
		int32_t L_61 = V_11;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_55, L_59, L_60, L_61, /*hidden argument*/NULL);
		// last = _blurBuffer1[level];
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_62 = __this->get__blurBuffer1_13();
		int32_t L_63 = V_13;
		int32_t L_64 = L_63;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_65 = (L_62)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_64));
		V_12 = L_65;
		// for (var level = 0; level < iterations; level++)
		int32_t L_66 = V_13;
...
IL_01b7:
	{
		...
		int32_t L_71 = V_14;
		int32_t L_72 = L_71;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_73 = (L_70)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_72));
		V_15 = L_73;
		...
		int32_t L_79;
		L_79 = VirtFuncInvoker0< int32_t >::Invoke(5 /* System.Int32 UnityEngine.Texture::get_width() */, L_78);
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_80 = V_15;
		int32_t L_81;
		L_81 = VirtFuncInvoker0< int32_t >::Invoke(7 /* System.Int32 UnityEngine.Texture::get_height() */, L_80);
		int32_t L_82 = V_2;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_83;
		L_83 = RenderTexture_GetTemporary_mEA38E780ED9C1E065B97E85BBC63F8DE548C7B8E(L_79, L_81, 0, L_82, /*hidden argument*/NULL);
		ArrayElementTypeCheck (L_76, L_83);
		(L_76)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_77), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)L_83);
...
IL_01fe:
	{
		...
		int32_t L_87 = V_14;
		int32_t L_88 = L_87;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_89 = (L_86)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_88));
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_90 = __this->get__material_11();
		int32_t L_91 = V_11;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_85, L_89, L_90, L_91, /*hidden argument*/NULL);
		// last = _blurBuffer2[level];
		RenderTextureU5BU5D_tDC947BF3616454E270458293C61A06867ED4B02E* L_92 = __this->get__blurBuffer2_14();
		int32_t L_93 = V_14;
		int32_t L_94 = L_93;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_95 = (L_92)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_94));
		V_12 = L_95;
		// for (var level = iterations - 2; level >= 0; level--)
		int32_t L_96 = V_14;
...
IL_024b:
	{
		...
		int32_t L_104 = V_11;
		IL2CPP_RUNTIME_CLASS_INIT(Graphics_t97FAEBE964F3F622D4865E7EC62717FE94D1F56D_il2cpp_TypeInfo_var);
		Graphics_Blit_mF7AA319E24D980D0E560A721966B87186392C3DD(L_101, L_102, L_103, L_104, /*hidden argument*/NULL);
...
IL_0262:
	{
		...
		int32_t L_106 = V_16;
		int32_t L_107 = L_106;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_108 = (L_105)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_107));
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_109;
		L_109 = Object_op_Inequality_mE1F187520BD83FB7D86A6D850710C4D42B864E90(L_108, (Object_tF2F3778131EFF286AF62B7B013A170F95A91571A *)NULL, /*hidden argument*/NULL);
		if (!L_109)
		{
			goto IL_0281;
		}
	}
	{
		...
		int32_t L_111 = V_16;
		int32_t L_112 = L_111;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_113 = (L_110)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_112));
		RenderTexture_ReleaseTemporary_m2BF2BDDC359A491C05C401B977878DAE1D0850D4(L_113, /*hidden argument*/NULL);
	}
...
IL_0281:
	{
		...
		int32_t L_115 = V_16;
		int32_t L_116 = L_115;
		RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 * L_117 = (L_114)->GetAtUnchecked(static_cast<il2cpp_array_size_t>(L_116));
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_118;
	...
	}
	{
		...
		RenderTexture_ReleaseTemporary_m2BF2BDDC359A491C05C401B977878DAE1D0850D4(L_122, /*hidden argument*/NULL);
	}
...
IL_02a0:
	{
		...
		(L_123)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_124), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)NULL);
		// _blurBuffer2[i] = null;
		...
		(L_125)->SetAtUnchecked(static_cast<il2cpp_array_size_t>(L_126), (RenderTexture_t5FE7A5B47EF962A0E8D7BEBA05E9FC87D49A1849 *)NULL);
		// for (var i = 0; i < kMaxIterations; i++)
		int32_t L_127 = V_16;
...
IL_02ba:
	...
	}
	{
		...
		RenderTexture_ReleaseTemporary_m2BF2BDDC359A491C05C401B977878DAE1D0850D4(L_129, /*hidden argument*/NULL);
		// }
		return;
	}
}
